...
/**
 * Abstract controller. Use {@link #registerEventKey(String, IEventListener)} and
 * {@link #registerEventKey(String, String)} to listen for events from the view objects. The
 * {@link #registerEventKey(String, String)} method is
