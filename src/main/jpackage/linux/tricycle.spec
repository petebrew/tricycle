...
ln -sfn /opt/tricycle/tricycle/bin/TRiCYCLE /usr/bin/tricycle
...
if [ -L /usr/bin/tricycle ] && [ "$(readlink /usr/bin/tricycle)" = "/opt/tricycle/tricycle/bin/TRiCYCLE" ]; then
  rm -f /usr/bin/tricycle
fi
